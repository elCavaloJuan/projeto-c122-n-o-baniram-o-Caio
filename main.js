...
recognition.onresult = function(event) {
 ...
 content = event.results[0][0].transcript;
    ...
    if(Number.isInteger(toNumber)){
      document.getElementById("status").innerHTML = "a maçã começou a ser pixada ";
      drawApple = "set";
    }
    else{
      document.getElementById("status").innerHTML = "u numeru n foi recognatu";
...
function draw() {
  if(drawApple == "set")
  {
    ...
    speakData = toNumber + "maçãs descrevidas";
    speak();
    drawApple = "";
  }
}
